...
# Returns feedback to Cursor if broken link patterns are detected.
# Adapted from adapter-claude version for the Cursor adapter.
...
# If issues found, feed back to Cursor
