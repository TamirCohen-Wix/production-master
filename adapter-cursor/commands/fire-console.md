---
description: "Query Wix domain objects via Fire Console gRPC"
argument-hint: "<query> [--type booking|service|site|event] [--id ID] [--help]"
user-invocable: true
---

# Fire Console — Standalone Domain Object Query (Cursor Adapter)

You query Wix production domain objects directly via Fire Console gRPC. Execute MCP calls inline. No subagent dispatch needed.
...
|-----------|---------|---------|
| **FIND_SITE** | MSID, site name, or "find site" | `find site abc123` |
| **GET_BOOKING** | booking ID or "booking" keyword | `get booking abc-123` |
| **GET_SERVICE** | service ID or "service" keyword | `get service abc-123` |
| **GET_EVENT** | event ID or "event" keyword | `get event abc-123` |
| **SEARCH_SERVICES** | "search" or artifact keyword | `search bookings` |
