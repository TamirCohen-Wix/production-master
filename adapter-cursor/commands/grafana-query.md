---
description: "Query Grafana production logs and metrics"
argument-hint: "<service> [--level ERROR] [--time 2h] [--help]"
user-invocable: true
---

# Grafana Query — Standalone Log & Metrics Tool (Cursor Adapter)

You query Grafana production data directly — app logs, access logs, request tracing, and Prometheus metrics. Execute MCP calls inline. No subagent dispatch needed.
