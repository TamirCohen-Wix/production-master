...
# Production Changes — Standalone Change Discovery Tool (Cursor Adapter)

You find recent PRs, commits, deployments, and feature toggle changes for a service or repo. Execute MCP calls inline. No subagent dispatch needed.
...
|-----------|---------|---------|
| **RECENT_PRS** | "PRs"/"pull requests"/"merged" | `recent PRs for scheduler` |
| **COMMITS** | "commits"/"changes" | `commits to bookings-service today` |
| **TOGGLE_CHANGES** | "toggle"/"feature flag" | `toggle changes for specs.bookings` |
| **ALL_CHANGES** | General / no specific type | `changes around 2026-02-10` |
